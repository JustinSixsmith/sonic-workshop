      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 flex">
          <div className="inline-flex rounded-md shadow">
            <a
              href="#"
              className="inline-flex items-center justify-center rounded border border-transparent bg-[#212936] px-4 py-2 text-sm font-medium text-[#cad2c5] hover:bg-[#181d24]"
            >
              Get started
            </a>
          </div>
          <div className="ml-3 inline-flex">
            <a
              href="#"
              className="inline-flex items-center justify-center rounded border border-transparent bg-[#ebebeb] px-4 py-2 text-sm font-medium text-[#212936] hover:bg-[#d5d5d5]"
            >
              Learn more
            </a>
          </div>
